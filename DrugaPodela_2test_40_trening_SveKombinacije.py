...
##########TEST=2################OSTATAK TRENING################################
###############################################################################

#######################BEZ NORMALIZACIJE#######################################
for treniranje_indeks, testiranje_indeks in leave_p_out.split(sensors):
...
for treniranje_indeks, testiranje_indeks in leave_p_out.split(min_max_data):
...
for treniranje_indeks, testiranje_indeks in leave_p_out.split(max_abs_data):
...
for treniranje_indeks, testiranje_indeks in leave_p_out.split(norm_data):
...
for treniranje_indeks, testiranje_indeks in leave_p_out.split(standard_data):
